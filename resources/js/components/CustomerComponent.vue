                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools" style="position: absolute; right: 1rem; top: .5rem">
                            <button type="button" @click="create" class="btn btn-info">Create <i
                                    class="fas fa-plus"></i></button>
                            <button type="button" @click="reload" class="btn btn-primary">Reload <i
...
<script>
    export default {
        ...
        methods: {
            getData() {
                this.$Progress.start();
                axios.get('/vuedataviewer/public/api/customers?page=' + this.pagination.current_page)
                    .then(response => {
            ...
            searchData() {
                this.$Progress.start()
                axios.get('/vuedataviewer/public/api/search/customers/' + this.queryField + '/' + this.query + '?page=' + this.pagination.current_page)
                    .then(response => {
                        this.customers = response.data.data
                        this.pagination = response.data.meta
                        this.$Progress.finish()
